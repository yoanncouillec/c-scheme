...
#define TOKEN_QUOTE 262
#define TOKEN_LAMBDA 263
#define TOKEN_LET 264
#define TOKEN_LETX 265
...
{
      12,     0,    -1,    13,    -1,     3,    -1,     4,    -1,    14,
      -1,    15,    -1,    16,    -1,    17,    -1,    18,    -1,     5,
       7,    13,     6,    -1,     5,     8,     5,     4,     6,    13,
       6,    -1,     5,    13,    13,     6,    -1,     5,     9,     5,
       4,    13,     6,    13,     6,    -1,     5,    10,     5,     4,
      13,     6,    13,     6,    -1
};
...
{
  "$end", "error", "$undefined", "TOKEN_INTEGER", "TOKEN_IDENT",
  "TOKEN_LPAREN", "TOKEN_RPAREN", "TOKEN_QUOTE", "TOKEN_LAMBDA",
  "TOKEN_LET", "TOKEN_LETX", "$accept", "START", "TERM", "QUOTE",
  "ABSTRACTION", "APPLICATION", "LET", "LETX", 0
};
#endif
...
{
      -2,    -4,    -4,     6,     4,    -4,    -4,    -4,    -4,    -4,
      -4,    -2,     0,     1,     2,    -2,    -4,    11,    14,    15,
      16,    17,    -4,    19,    -2,    -2,    -4,    -2,    20,    21,
      24,    -2,    -2,    -4,    25,    26,    -4,    -4
};
...
{
      15,     1,     2,     3,    16,    18,    19,    20,    17,     1,
       2,     3,    21,    11,    12,    13,    14,    22,    23,    24,
      25,    28,    29,    26,    30,    27,    31,    32,    34,    35,
      33,    36,    37
};

static const yytype_uint8 yycheck[] =
{
       3,     3,     4,     5,     0,     5,     5,     5,    11,     3,
       4,     5,    15,     7,     8,     9,    10,     6,     4,     4,
       4,    24,    25,     6,    27,     6,     6,     6,    31,    32,
       6,     6,     6
};
...
static const yytype_uint8 yystos[] =
{
      ...
      18,     7,     8,     9,    10,    13,     0,    13,     5,     5,
       5,    13,     6,     4,     4,     4,     6,     6,    13,    13,
      13,     6,     6,     6,    13,    13,     6,     6
};
...
#line 26 "fun.yacc"
  ...
  case 3:
#line 29 "fun.yacc"
    { (yyval.term) = make_term_integer ((yyvsp[(1) - (1)].integer)) ; }
    break;

  case 4:
#line 30 "fun.yacc"
    { (yyval.term) = make_term_variable ((yyvsp[(1) - (1)].ident)) ; }
    break;
...
#line 35 "fun.yacc"
  ...
  case 10:
#line 39 "fun.yacc"
    { (yyval.term) = make_term_quote ((yyvsp[(3) - (4)].term)) ; }
    break;

  case 11:
#line 43 "fun.yacc"
    { (yyval.term) = make_term_abstraction ((yyvsp[(4) - (7)].ident), (yyvsp[(6) - (7)].term)) ; }
    break;

  case 12:
#line 46 "fun.yacc"
    { (yyval.term) = make_term_application ((yyvsp[(2) - (4)].term), (yyvsp[(3) - (4)].term)) ; }
    break;

  case 13:
#line 52 "fun.yacc"
    { (yyval.term) = make_term_let ((yyvsp[(4) - (8)].ident), (yyvsp[(5) - (8)].term), (yyvsp[(7) - (8)].term)) ; }
    break;

  case 14:
#line 56 "fun.yacc"
    { (yyval.term) = make_term_application (make_term_abstraction ((yyvsp[(4) - (8)].ident), (yyvsp[(7) - (8)].term)), (yyvsp[(5) - (8)].term)) ; }
    break;
